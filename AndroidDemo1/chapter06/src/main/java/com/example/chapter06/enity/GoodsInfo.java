...
public class GoodsInfo {
    ...
    // 声明一个手机商品的大图数组
    private static int[] mPicArray = {com.example.chapter06.R.drawable.iphone, com.example.chapter06.R.drawable.huawei, R.drawable.xiaomi, R.drawable.oppo, R.drawable.vivo, R.drawable.rongyao,};
